  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div className="flex items-center gap-2">
        <Button variant="ghost" size="sm" render={<Link href="/admin/checkpoints" />}>
      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <p className="text-sm text-muted-foreground">
            The routing engine picks one of these based on live conditions. Leave all unchecked
            to let the engine consider every checkpoint.
          </p>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <p className="text-sm text-muted-foreground">
            Level 1 is cryptic, the last level is a direct instruction. Teams routed here see
            these clues.
          </p>
        </CardHeader>
        <CardContent>
